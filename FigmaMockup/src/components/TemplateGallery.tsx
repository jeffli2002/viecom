...
const templates: Template[] = [
  {
    ...
    prompt: 'Professional product photography on pure white background, centered, soft shadows, studio lighting, high resolution, commercial quality',
  ...
  },
  {
    ...
    type: 'image',
    category: 'Lifestyle',
    prompt: 'Product in natural lifestyle setting, warm ambient lighting, cozy atmosphere, depth of field, lifestyle photography',
  ...
  },
  {
    ...
    prompt: 'Smooth 360-degree rotation of product, professional studio lighting, clean background, seamless loop, 4K quality',
  ...
  },
  {
    ...
    type: 'image',
    category: 'Marketing',
    prompt: 'Dramatic hero banner image, dynamic composition, bold lighting, high contrast, attention-grabbing, professional marketing photography',
  ...
  },
  {
    ...
    type: 'video',
    category: 'Product Video',
    prompt: 'Product demonstration highlighting key features, close-up shots, smooth transitions, professional presentation, clear and engaging',
  ...
  },
  {
    ...
    type: 'image',
    category: 'Product Photography',
    prompt: 'Flat lay composition from above, products artfully arranged, minimalist aesthetic, balanced layout, soft natural lighting',
    ...
    <div className="space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-slate-600">
          Start with pre-made templates optimized for e-commerce
        </p>
      </div>
