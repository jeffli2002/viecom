      ...
      <div className="space-y-6 text-gray-700">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-amber-800">
                  As a digital service provider, all purchases of credits, subscriptions, and credit packs are final and non-refundable. 
                  Please carefully review your purchase before completing the transaction.
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <Card>
          <CardContent className="pt-6 space-y-4">
            ...
            <p>
              Due to the nature of digital services and AI-generated content, <strong>all sales are final and non-refundable</strong>. 
        ...
        <Card>
          <CardContent className="pt-6 space-y-4">
            ...
            <p>
              Our digital services involve the immediate consumption of computational resources and AI processing. Once you:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <p className="mt-4">
              ...
              Therefore, we cannot offer refunds for digital services that have been accessed or utilized.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="pt-6 space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li><strong>Cancellation:</strong> You can cancel your subscription from your account dashboard</li>
              <li><strong>Access Period:</strong> After cancellation, you will retain access to your subscription benefits until the end of your current billing period</li>
              <li><strong>Credits:</strong> Any unused monthly credits will expire at the end of the billing period</li>
              <li><strong>No Partial Refunds:</strong> Cancelling mid-cycle does not entitle you to a partial refund</li>
              <li><strong>Purchased Credits:</strong> One-time purchased credit packs never expire and remain in your account even after subscription cancellation</li>
            </ul>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="pt-6 space-y-4">
            ...
            <p>
              We may consider refund requests only in the following exceptional circumstances:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li><strong>Duplicate Charges:</strong> If you were charged multiple times for the same purchase due to a technical error</li>
              <li><strong>Unauthorized Transactions:</strong> If your account was compromised and unauthorized purchases were made (subject to verification)</li>
              <li><strong>Service Failure:</strong> If our platform experienced a complete service outage preventing you from using purchased credits (limited to the affected credits only)</li>
            </ul>
            
            <p className="mt-4">
              To request a refund review under these exceptional circumstances, please contact our support team at{' '}
        ...
        <Card>
          <CardContent className="pt-6 space-y-4">
            ...
            <p>
              We encourage you to utilize our free tier to test our services before making a purchase:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li><strong>Free Plan:</strong> All users receive 30 sign-up bonus credits</li>
              <li><strong>Daily Rewards:</strong> Earn 2 credits per day through check-ins</li>
              <li><strong>Referral Rewards:</strong> Earn 10 credits per successful referral</li>
              <li><strong>Social Sharing:</strong> Earn 5 credits per share</li>
            </ul>
            
            <p className="mt-4">
              These free credits allow you to test image and video generation quality before committing to a paid plan.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="pt-6 space-y-4">
            ...
            <p>
              If you file a chargeback or dispute a valid charge with your payment provider:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4">
        ...
        <Card>
          <CardContent className="pt-6 space-y-4">
            ...
            <p>
              We reserve the right to modify our pricing at any time. However:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>Existing subscribers will be grandfathered at their current rate for the duration of their subscription</li>
        ...
        <Card>
          <CardContent className="pt-6 space-y-4">
            ...
            <ul className="list-none space-y-2 ml-4">
              <li><strong>Email:</strong> <a href="mailto:support@viecom.pro" className="text-purple-600 hover:underline">support@viecom.pro</a></li>
              <li><strong>Support:</strong> <Link href="/contact" className="text-purple-600 hover:underline">Contact Page</Link></li>
            </ul>
