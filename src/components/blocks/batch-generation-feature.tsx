...
import { Layers, Target, FileSpreadsheet } from 'lucide-react';
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
             <div>
                ...
                <h2 className="h2-section">
                   {t('title')} <br/>
                   <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-500 to-blue-500">{t('titleHighlight')}</span>
                </h2>
                ...
                <div className="flex flex-col gap-4">
                    <div className="flex items-start gap-4 p-4 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">{t('feature1Desc')}</p>
                        </div>
                    </div>
                    <div className="flex items-start gap-4 p-4 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">{t('feature2Desc')}</p>
                        </div>
                    </div>
                </div>
             </div>
             ...
             <div className="relative">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-gradient-to-tr from-teal-500/20 to-blue-500/20 blur-3xl rounded-full -z-0"></div>
             </div>
          </div>
       </div>
    </section>
