import { Image, Loader2, Video, Wand2 } from 'lucide-react';
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <Slider value={quality} onValueChange={setQuality} min={50} max={100} step={10} />
          </div>
          ...
          {/* Submit Button */}
          <Button type="submit" className="w-full gap-2" size="lg" disabled={isGenerating}>
            {isGenerating ? (
              <>
          ...
          <p className="text-sm text-slate-500 text-center">
            Note: Connect your AI API keys (OpenAI, Stability AI, Runway ML, etc.) in your backend
