...
import { 
  ...
  Plus, Minus, Loader2, Cpu, Scan, Activity
} from 'lucide-react';
...
const PRICING_PLANS = [
  ...
  },
  {
    ...
    features: ['Unlimited Generations', 'Custom AI Models', 'API Access', 'Dedicated Success Manager', 'SSO & Security'],
    cta: 'Contact Sales',
    highlight: false
  }
];
...
const FAQ_ITEMS = [
  {
    ...
    answer: "Yes! All content generated on our Pro and Enterprise plans comes with a full commercial license, allowing you to use it for paid advertising on Facebook, TikTok, Instagram, and Amazon."
  },
  {
  ...
  },
  {
    ...
    answer: "Starter plans support 720p HD. Pro and Enterprise plans unlock 4K Ultra HD rendering for crisp, professional-quality visuals suitable for large screens and premium ad placements."
  },
  {
        ...
        <div className="relative">
            ...
            <div className="grid lg:grid-cols-12 gap-6 items-center max-w-7xl mx-auto min-h-[600px]">
               ...
               <div className="lg:col-span-5 space-y-6 relative z-20">
                  <div className="relative group">
                    <div className="absolute -inset-1 bg-gradient-to-r from-brand-teal to-purple-600 rounded-2xl opacity-20 blur transition duration-500 group-hover:opacity-40"></div>
                    <div className="glass-card p-8 rounded-2xl relative shadow-2xl">
                      ...
                      <div key={activeScenario.id} className="grid grid-cols-2 gap-6 animate-in fade-in slide-in-from-left-4 duration-500">
                         <div className="space-y-3">
                            <span className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">{activeScenario.input1.label}</span>
                            <div className="aspect-[3/4] rounded-2xl overflow-hidden bg-slate-100 dark:bg-slate-800 border-2 border-slate-200 dark:border-slate-700 relative group/input cursor-zoom-in shadow-inner">
                                 <img src={activeScenario.input1.image} className="w-full h-full object-cover transition-transform duration-500 group-hover/input:scale-110" alt="Input 1" />
                            </div>
                         </div>
                         <div className="space-y-3">
                            <span className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">{activeScenario.input2.label}</span>
                            <div className="aspect-[3/4] rounded-2xl overflow-hidden bg-slate-100 dark:bg-slate-800 border-2 border-slate-200 dark:border-slate-700 relative group/input cursor-zoom-in shadow-inner">
                                 <img src={activeScenario.input2.image} className="w-full h-full object-cover transition-transform duration-500 group-hover/input:scale-110" alt="Input 2" />
                            </div>
                         </div>
                      </div>
     ...
     <div className="container-base">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
           <div>
              ...
              <h2 className="h2-section">
                 Scale Content <br/>
                 <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-teal to-brand-blue">Exponentially</span>
              </h2>
              <p className="text-lg text-body leading-relaxed mb-8">
                 Need to launch a campaign across 5 platforms? Generate hundreds of variations for A/B testing or multi-channel distribution in a single click.
              </p>
              ...
              <div className="flex flex-col gap-4">
                  <div className="flex items-start gap-4 p-4 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm">
                      ...
                      <div>
                          ...
                          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Automatically resize and recompose for Stories, Posts, Banners, and Ads.</p>
                      </div>
                  </div>
                  <div className="flex items-start gap-4 p-4 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm">
                      ...
                      <div>
                          ...
                          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Upload your entire product catalog spreadsheet and let AI do the rest.</p>
                      </div>
                  </div>
              </div>
           </div>
           ...
           <div className="relative">
              <div className="grid grid-cols-2 gap-4 relative z-10">
                  {[1,2,3,4].map(i => (
                      <div key={i} className={`aspect-square rounded-2xl overflow-hidden shadow-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 transform transition-transform hover:scale-105 ${i%2===0 ? 'translate-y-8' : ''}`}>
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-gradient-to-tr from-brand-teal/20 to-brand-blue/20 blur-3xl rounded-full -z-0"></div>
           </div>
        </div>
     </div>
  </section>
      ...
      <div className="container-base">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-6">
          <div>
            ...
            <h2 className="h2-section">
               Static to <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-teal to-brand-blue">Cinematic</span>
            </h2>
            <p className="text-body max-w-xl text-sm md:text-base">
               Generate high-fidelity video assets from a single product image. 
               Control camera motion, lighting, and physics with simple text prompts.
            </p>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 h-full">
                    ...
                    <div className="p-5 flex-1 flex flex-col gap-6 overflow-y-auto custom-scrollbar">
                        ...
                        <div className="space-y-2">
                             <div className="relative aspect-[3/4] w-full rounded-xl overflow-hidden border border-slate-700 group bg-slate-800 shadow-inner">
                                 <img src={activeDemo.input} className="w-full h-full object-cover transition-all duration-500 group-hover:scale-105 group-hover:opacity-50" alt="Input" />
                        ...
                        <div className="flex-1 min-h-[100px] bg-black/20 rounded-xl border border-slate-800 p-4 flex flex-col gap-3 shadow-inner">
                            <div className="flex items-center justify-between">
                                ...
                                <span className="text-[10px] text-slate-600 font-mono">{(activeDemo.prompt.length)} chars</span>
                            </div>
                            <textarea 
                                readOnly
                ...
                <div className="lg:col-span-6 bg-[#0f172a] relative flex flex-col h-full">
                    ...
                    <div className="h-14 flex items-center justify-between px-6 border-b border-slate-800 bg-slate-900 z-20 flex-shrink-0">
                        <div className="flex items-center gap-4">
                            ...
                            <span className="text-xs font-mono text-slate-500 flex items-center gap-2">
                                <Ratio className="w-3 h-3" /> {activeDemo.ratio === '9:16' ? '1080x1920' : '1920x1080'}
                            </span>
                        </div>
                    ...
                    <div className="flex-1 relative flex items-center justify-center overflow-hidden bg-[#0a0f1e]">
                        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(20,184,166,0.1),transparent_70%)] pointer-events-none"></div>
                        ...
                        {isGenerating && (
                            <div className="absolute inset-0 z-50 bg-[#0f172a]/95 backdrop-blur-md flex flex-col items-center justify-center p-8 transition-all duration-300">
                                ...
                                <div className="relative w-32 h-32 mb-8">
                                    ...
                                    <div className="absolute inset-0 border-2 border-brand-teal rounded-full border-t-transparent animate-spin"></div>
                                    
                                    {/* Inner Ring Reverse */}
                                    <div className="absolute inset-4 border-2 border-slate-700 rounded-full"></div>
                                    <div className="absolute inset-4 border-2 border-brand-blue rounded-full border-b-transparent animate-spin opacity-70" style={{animationDirection: 'reverse', animationDuration: '3s'}}></div>
                                ...
                                <div className="w-64 grid grid-cols-4 gap-1">
                                     {[1, 2, 3, 4].map((i) => (
                                         <div key={i} className={`h-1 rounded-full transition-colors duration-300 ${
                                             progress >= i * 25 ? 'bg-brand-teal shadow-[0_0_10px_rgba(20,184,166,0.5)]' : 
                                             progress >= (i-1) * 25 + 10 ? 'bg-brand-teal/50' : 'bg-slate-800'
                                         }`}></div>
                                     ))}
                                </div>
                                ...
                                <div className="mt-8 font-mono text-[10px] text-slate-500 space-y-1 text-center opacity-70">
                                    ...
                                    <div className={progress > 20 ? 'text-slate-400' : 'hidden'}> > Geometry inference: OK</div>
                                    <div className={progress > 50 ? 'text-slate-400' : 'hidden'}> > Physics simulation: ACTIVE</div>
                                </div>
                            </div>
                        )}
                        ...
                        <div className="w-full h-full flex items-center justify-center p-4 relative group">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                                <div className={`w-20 h-20 rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center transform transition-all duration-300 shadow-2xl ${isPlaying && !isGenerating ? 'opacity-0 scale-90' : 'opacity-100 scale-100'} ${isGenerating ? 'hidden' : ''}`}>
                    ...
                    <div className="h-14 bg-slate-900 border-t border-slate-800 flex items-center px-6 gap-4 flex-shrink-0">
                        ...
                        <div className="flex-1 h-12 flex items-center group cursor-pointer">
                            <div className="w-full h-1.5 bg-slate-800 rounded-full overflow-hidden relative">
                                <div className="absolute top-0 left-0 h-full w-1/3 bg-brand-teal group-hover:bg-teal-400 transition-colors"></div>
                                <div className="absolute top-1/2 left-1/3 -translate-y-1/2 w-3 h-3 bg-white rounded-full shadow-md opacity-0 group-hover:opacity-100 transition-opacity"></div>
                            </div>
                        </div>
       ...
       <div className="container-base">
          <div className="flex justify-between items-end mb-8">
            <div>
                ...
                See what others are creating with EcomGen.ai
                </p>
            </div>
          </div>
            ...
            <div className="container-base">
                <div className="text-center mb-16">
                    ...
                    <div className="flex items-center justify-center gap-4 mb-8">
                        ...
                        >
                            <div className={`absolute top-1 w-5 h-5 bg-white rounded-full transition-transform duration-300 shadow-sm ${isAnnual ? 'left-8' : 'left-1'}`}></div>
                        </button>
                        <span className={`text-sm font-medium ${isAnnual ? 'text-slate-900 dark:text-white' : 'text-slate-500'}`}>
                            Yearly <span className="text-brand-teal text-xs font-bold bg-brand-teal/10 px-2 py-0.5 rounded-full ml-1">-20%</span>
                        </span>
                    </div>
                </div>
                        ...
                        <div key={plan.name} className={`relative rounded-2xl p-8 transition-all duration-300 ${
                            ...
                            <div className="flex items-baseline gap-1 mb-4">
                                <span className="text-4xl font-bold text-slate-900 dark:text-white">
                                    ${plan.price === 'Custom' ? 'Custom' : (isAnnual && plan.price !== '0' ? Math.floor(Number(plan.price) * 0.8) : plan.price)}
                                </span>
      ...
      <div className="container-base max-w-3xl">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-body">
            Everything you need to know about EcomGen.ai
          </p>
        </div>
          ...
          {FAQ_ITEMS.map((item, index) => (
            ...
            >
              ...
              >
                ...
                <span className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center border transition-all duration-300 ${openIndex === index ? 'bg-brand-teal border-brand-teal text-white rotate-180' : 'border-slate-300 dark:border-slate-600 text-slate-500'}`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                <div className="space-y-6">
                    ...
                    <p className="text-body leading-relaxed">
                        Empowering e-commerce brands with generative AI to create high-converting visuals at scale.
                    </p>
                    <div className="flex gap-4">
                        {[Twitter, Instagram, Linkedin, Github].map((Icon, i) => (
                            <a key={i} href="#" className="p-2 rounded-full bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-brand-teal hover:text-white transition-all">
                ...
                <div>
                    ...
                    <ul className="space-y-4 text-sm text-slate-600 dark:text-slate-400">
                        <li><a href="#" className="hover:text-brand-teal transition-colors">Video Generation</a></li>
                        <li><a href="#" className="hover:text-brand-teal transition-colors">Image Studio</a></li>
                        <li><a href="#" className="hover:text-brand-teal transition-colors">Brand Guard™</a></li>
                        <li><a href="#" className="hover:text-brand-teal transition-colors">Batch Processing</a></li>
                ...
                <div>
                    ...
                    <ul className="space-y-4 text-sm text-slate-600 dark:text-slate-400">
                        ...
                        <li><a href="#" className="hover:text-brand-teal transition-colors">Case Studies</a></li>
...
const Navbar = ({ darkMode, setDarkMode }) => {
    ...
    return (
      <nav className={`fixed w-full z-50 transition-all duration-300 ${isScrolled ? 'glass-card border-b py-4' : 'bg-transparent py-6'}`}>
        <div className="container-base">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 text-2xl font-bold font-display text-slate-900 dark:text-white">
            ...
            <div className="hidden md:flex items-center gap-8">
              <a href="#features" className="text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-brand-teal dark:hover:text-white transition-colors">Features</a>
              <a href="#studio" className="text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-brand-teal dark:hover:text-white transition-colors">Studio</a>
              <a href="#pricing" className="text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-brand-teal dark:hover:text-white transition-colors">Pricing</a>
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute top-full left-0 w-full bg-main border-b border-slate-200 dark:border-slate-800 p-4 shadow-xl animate-in slide-in-from-top-5">
             <div className="flex flex-col gap-4">
              <a href="#features" className="text-base font-medium text-slate-900 dark:text-white p-2 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg">Features</a>
              <a href="#studio" className="text-base font-medium text-slate-900 dark:text-white p-2 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg">Studio</a>
              <a href="#pricing" className="text-base font-medium text-slate-900 dark:text-white p-2 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg">Pricing</a>
              <button className="w-full py-3 bg-brand-teal text-white font-bold rounded-xl mt-2">Get Started Free</button>
             </div>
          </div>
        )}
      </nav>
