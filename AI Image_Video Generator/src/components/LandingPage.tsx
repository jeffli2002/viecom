        ...
        <div className="container mx-auto max-w-7xl">
          ...
          >
            ...
            >
              ...
              <br />
              No photoshoot. No editing. Just results.
            </motion.p>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-24">
            ...
            >
              ...
              <p className="text-lg text-slate-600 leading-relaxed">
                Turn static product images into dynamic videos with smooth animations, 360°
                rotations, and professional transitions. Perfect for social media, ads, and product
                pages.
              </p>
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">
                      Studio, lifestyle, minimal, and creative presets
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
      ...
      <section className="py-32 px-6 bg-white">
        <div className="container mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Follow this simple guide to transform your product photography and start creating
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-24">
            ...
            >
              ...
              <p className="text-xl text-slate-600 leading-relaxed">
                Start by uploading a photo of your product. Don't worry about the background or
                lighting – our AI will handle that. You can upload images in any format (JPG, PNG,
                WEBP) and our system will automatically optimize them.
              </p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-slate-900">
                      Take a clear photo of your product against any background
                    </p>
                    <p className="text-sm text-slate-600">
                      Use natural lighting or basic indoor lighting
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-slate-900">
                      Upload directly or drag & drop into the platform
                    </p>
                    <p className="text-sm text-slate-600">
                      Supports batch uploads for multiple products
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-slate-900">
                      AI automatically detects and isolates your product
                    </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-24">
            ...
            >
              ...
              <p className="text-xl text-slate-600 leading-relaxed">
                Select from our library of professional styles or create your own. Customize every
                aspect – from background scenes to lighting, colors, and composition. Our intuitive
                interface makes it easy to get exactly the look you want.
              </p>
              <div className="space-y-4 pl-2">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-slate-900">
                      Pick a style: Professional, Lifestyle, Minimal, or Creative
                    </p>
                    <p className="text-sm text-slate-600">
                      Each style is optimized for e-commerce conversions
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-slate-900">
                      Customize background, lighting, and composition
                    </p>
                    <p className="text-sm text-slate-600">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">
                      Square, portrait, landscape, or custom dimensions
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-24">
            ...
            >
              ...
              <p className="text-xl text-slate-600 leading-relaxed">
                Click generate and watch the magic happen. Our AI creates your professional visual
                in seconds. Not satisfied? Adjust your settings and regenerate instantly. You can
                create unlimited variations until you get the perfect result.
              </p>
              <div className="space-y-4 pl-2">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">
                      Lightning-fast processing with our advanced models
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-slate-600 leading-relaxed">
                Download your professional visual in high resolution (up to 4K) and use it anywhere
                – on your website, social media, ads, or print materials. All downloads are
                royalty-free and ready for commercial use.
              </p>
              <div className="space-y-4 pl-2">
                <div className="flex items-start gap-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">
                      Perfect for large format printing and high-res displays
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">
                      Use on any platform without restrictions
                    </p>
                  </div>
                </div>
              </div>
      ...
      <footer className="bg-slate-950 text-slate-400 py-12 px-6">
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <p className="text-sm">© 2025 E-Commerce AI Studio. Crafted with AI ✨</p>
          </div>
        </div>
      </footer>
